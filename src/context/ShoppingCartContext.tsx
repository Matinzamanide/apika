...
const ShoppingCartContextProvider: React.FC<IChildren> = ({ children }) => {
  ...
  return (
    <ShoppingCartContext.Provider value={{ cartItems,handleIncreaseQty,handleDecreaseProductQty,getProductQty,cartTotalQty,handleRemoveProduct }}>
      {children}
...
//         try {
//           const res = await fetch(`http://localhost/apitak/cart/get_cart.php?phone=${phoneNumber}`);
...
//     try {
//       await fetch("http://localhost/apitak/cart/update_cart.php", {
//         method: "POST",
